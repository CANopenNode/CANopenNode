...
/*******************************************************************************
   FILE INFO:
      FileName:     CANopen_Unit_s32k144
      FileVersion:  1.0
      CreationTime: 16:45:42
...
/*2130      */ OD_time_t      time;
/*3000      */ INTEGER16      sensor_Temperature;
/*3001      */ INTEGER16      control_Temperature;
/*3100      */ INTEGER8       unit_State;
...
/*3000, Data Type: INTEGER16 */
      #define OD_sensor_Temperature                      CO_OD_RAM.sensor_Temperature

/*3001, Data Type: INTEGER16 */
      #define OD_control_Temperature                     CO_OD_RAM.control_Temperature

/*3100, Data Type: INTEGER8 */
      #define OD_unit_State                              CO_OD_RAM.unit_State
