...
/*******************************************************************************
   FILE INFO:
      FileName:     iMaxeon
      FileVersion:  3
      CreationTime: 08:47:43
      CreationDate: 2014-09-02
      CreatedBy:    AH
*******************************************************************************/
...
/*6000      */ UNSIGNED32     controlWord;
/*6001      */ UNSIGNED32     statusWord;
/*6002      */ UNSIGNED8      injectionMode;
/*6003      */ UNSIGNED8      setDateAndTime[6];
/*6006      */ UNSIGNED8      communicationLost;
/*6007      */ UNSIGNED32     functionsSupported;
/*6008      */ UNSIGNED16     globalAttributesSupport[2];
/*6009      */ UNSIGNED16     currentInjectedTotalVolume;
/*600A      */ UNSIGNED16     currentPressure;
/*600B      */ UNSIGNED16     currentTotalFlowRate;
/*600C      */ UNSIGNED16     currentVolumeRemaining[8];
/*6070      */ UNSIGNED32     medicalDiagnosticDeviceIdentity[4];
/*6073      */ UNSIGNED32     profileVersion;
...
/*6002, Data Type: UNSIGNED8 */
      #define OD_injectionMode                           CO_OD_RAM.injectionMode

/*6003, Data Type: UNSIGNED8, Array[6] */
      #define OD_setDateAndTime                          CO_OD_RAM.setDateAndTime
      #define ODL_setDateAndTime_arrayLength             6
      #define ODA_setDateAndTime_year                    0
      #define ODA_setDateAndTime_day                     1
      #define ODA_setDateAndTime_month                   2
      #define ODA_setDateAndTime_hour                    3
      #define ODA_setDateAndTime_minute                  4
      #define ODA_setDateAndTime_second                  5

/*6006, Data Type: UNSIGNED8 */
      #define OD_communicationLost                       CO_OD_RAM.communicationLost

/*6007, Data Type: UNSIGNED32 */
      #define OD_functionsSupported                      CO_OD_RAM.functionsSupported

/*6008, Data Type: UNSIGNED16, Array[2] */
      #define OD_globalAttributesSupport                 CO_OD_RAM.globalAttributesSupport
      #define ODL_globalAttributesSupport_arrayLength    2
      #define ODA_globalAttributesSupport_attributes_implemented 0
      #define ODA_globalAttributesSupport_support_attributes 1

/*6009, Data Type: UNSIGNED16 */
      #define OD_currentInjectedTotalVolume              CO_OD_RAM.currentInjectedTotalVolume

/*600A, Data Type: UNSIGNED16 */
      #define OD_currentPressure                         CO_OD_RAM.currentPressure

/*600B, Data Type: UNSIGNED16 */
      #define OD_currentTotalFlowRate                    CO_OD_RAM.currentTotalFlowRate

/*600C, Data Type: UNSIGNED16, Array[8] */
      #define OD_currentVolumeRemaining                  CO_OD_RAM.currentVolumeRemaining
      #define ODL_currentVolumeRemaining_arrayLength     8

/*6070, Data Type: UNSIGNED32, Array[4] */
      #define OD_medicalDiagnosticDeviceIdentity         CO_OD_RAM.medicalDiagnosticDeviceIdentity
      #define ODL_medicalDiagnosticDeviceIdentity_arrayLength 4
      #define ODA_medicalDiagnosticDeviceIdentity_vendorId 0
      #define ODA_medicalDiagnosticDeviceIdentity_productCode 1
      #define ODA_medicalDiagnosticDeviceIdentity_revisionNumber 2
      #define ODA_medicalDiagnosticDeviceIdentity_serialNumber 3

/*6073, Data Type: UNSIGNED32 */
      #define OD_profileVersion                          CO_OD_RAM.profileVersion
