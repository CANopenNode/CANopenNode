 ...
 * inside parameters describing &lt;CANopenObject&gt;s:
 *   * &lt;property name="CO_storageGroup" value="..."&gt; - group into which
 *     the C variable will belong. Valid value is from 0x00 (default) to 0x7F.
 ...
 *
 * Additional, optional, CANopenNode specific property, which can be used
 * inside parameters describing string or domain (VAR):
 *   * &lt;property name="CO_byteLength" value="..."&gt; - Length of the
 *     variable in bytes. If this is not specified, then length is calculated
 *     from &lt;defaultValue&gt;.
 *
